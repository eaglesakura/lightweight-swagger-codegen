...
class GaeGoCodegen extends DefaultCodegen implements CodegenConfig {
    static Logger LOGGER = LoggerFactory.getLogger(GaeGoCodegen.class)
    ...
    String getHelp() {
        return "Generates a GAE/Go Server library."
    }
