...
public class UndertowCodegen extends AbstractJavaCodegen {
    ...
    public void processOpts() {
        ...
        supportingFiles.add(new SupportingFile("swagger.mustache", ("src.main.resources.config").replace(".", File.separator), "swagger.json"));
        supportingFiles.add(new SupportingFile("handler.mustache", ("src.main.java.io.swagger.handler").replace(".", File.separator), "PathHandlerProvider.java"));
        supportingFiles.add(new SupportingFile("service.mustache", ("src.main.resources.META-INF.services").replace(".", File.separator), "com.networknt.server.HandlerProvider"));

        // configuration files
        supportingFiles.add(new SupportingFile("server.json", ("src.main.resources.config").replace(".", File.separator), "server.json"));
        supportingFiles.add(new SupportingFile("security.json", ("src.main.resources.config").replace(".", File.separator), "security.json"));
        supportingFiles.add(new SupportingFile("primary.crt", ("src.main.resources.config.oauth").replace(".", File.separator), "primary.crt"));
    ...
    */
    ...
    public String apiFilename(String templateName, String tag) {
        ...
        if ( templateName.endsWith("api.mustache") ) {
            ...
            new File(beg + implFolder).mkdirs();
